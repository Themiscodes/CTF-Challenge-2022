...
The purpose of this competition was to learn the basic techniques of vulnerability assessment, cryptography and exploitation in six security challenges of increasing difficulty. Among the methods were file forensics, breaking encryption schemes such as RSA, AES and Shamir's Secret Sharing and binary exploitation through buffer overflow attacks.
